...
const embedCode = ref(`
<iframe style="width:100%;height:600px" src="https://online.anyflip.com/ujmxk/gkcv/index.html"  seamless="seamless" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" ></iframe>
`)
</script>
    ...
    <div class="mt-5">
      ...
      <base-card class="mb-5">
        ...
        <v-list density="compact" class="program-list">
          <v-list-item>
            <div class="d-flex">
              <span class="time-col">10:00 – 17:00</span>
              <span>Registration</span>
            </div>
          </v-list-item>
        </v-list>
        <div class="hall-info mt-2"><b>Hall Biljana (Hall 1)</b></div>
        <v-list density="compact" class="program-list">
          <v-list-item>
            <div class="d-flex">
