  ...
  <base-container>
    <base-card>
      ...
      <base-paragraph>
        ...
        &#11088;&#11088;Students (under and post-graduated)
      </base-paragraph>
      <!-- Payment Details -->
      ...
      <!-- Note about VAT -->
      <paragraph-no-indent class="text-center mt-10">
        <b><span class="text-red">ALL PRICES INCLUDE 18% VAT</span></b>
      </paragraph-no-indent>
      <paragraph-no-indent class="text-center text-red">
    ...
    <!-- <small-card class="mt-10" v-if="!hide">
      <v-form @submit.prevent="handleSubmit" ref="formRef">
        <v-text-field variant="outlined" density="comfortable" v-model="form.name" label="Name" required
          :rules="validRule" />
        <v-text-field variant="outlined" density="comfortable" v-model="form.email" label="Email" required type="email"
          :rules="validRule" />
